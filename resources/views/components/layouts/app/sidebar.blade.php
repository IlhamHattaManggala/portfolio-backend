        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Admin')" class="grid">
                    <flux:navlist.item icon="folder-git-2" :href="route('admin.projects.index')" :current="request()->routeIs('admin.projects.*')" wire:navigate>{{ __('Projects') }}</flux:navlist.item>
                    <flux:navlist.item icon="layout-grid" :href="route('admin.technologies.index')" :current="request()->routeIs('admin.technologies.*')" wire:navigate>{{ __('Technologies') }}</flux:navlist.item>
